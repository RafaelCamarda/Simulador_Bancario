...
public class MyServerSocket implements Runnable{
    ...
    private TrataConexaoServidorLog trata = null;
    private String line;
    ...
    public void run() {
        try{
            ...
            JOptionPane.showMessageDialog(null, "Servidor de LOG está executando");
            connected = true;
            ...
            while(connected == true){
                ...
                trata = new TrataConexaoServidorLog(connection);
